...
client.on('ready', function () {
    ...
    client.user.setGame(`Santos System ( Prefix: + )`,"http://twitch.tv/Death Shop")
})

client.on('guildMemberAdd', member =>{
    member.guild.channels.get('613794960033972245').send(' **Hello** ' + member.user + ', **Welcome to Santos** , **We are now** ' + member.guild.memberCount + ' **Members** ! :heart:');
    console.log('+1');
});
